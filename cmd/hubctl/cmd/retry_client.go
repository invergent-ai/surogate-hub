...
func NewRetryClient(retriesCfg RetriesCfg, transport *http.Transport) *http.Client {
	...
	retryClient.CheckRetry = hubctlRetryPolicy
	return retryClient.StandardClient()
}

// hubctl retry policy - we retry in the following cases:
...
func hubctlRetryPolicy(ctx context.Context, resp *http.Response, err error) (bool, error) {
