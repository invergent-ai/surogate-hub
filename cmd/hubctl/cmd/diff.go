...
var diffCmd = &cobra.Command{
	...
	Example: fmt.Sprintf(`
	hubctl diff lakefs://example-repo/example-branch
	Show uncommitted changes in example-branch.

	hubctl diff lakefs://example-repo/main lakefs://example-repo/dev
	...
	hubctl diff --%s lakefs://example-repo/main lakefs://example-repo/dev
	...
	hubctl diff --%s some/path lakefs://example-repo/main lakefs://example-repo/dev
