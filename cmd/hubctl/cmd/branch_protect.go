...
var branchProtectListCmd = &cobra.Command{
	...
	Example:           "hubctl branch-protect list " + myRepoExample,
...
var branchProtectAddCmd = &cobra.Command{
	...
	Example:           "hubctl branch-protect add " + myRepoExample + " 'stable_*'",
...
var branchProtectDeleteCmd = &cobra.Command{
	...
	Example:           "hubctl branch-protect delete " + myRepoExample + " stable_*",
