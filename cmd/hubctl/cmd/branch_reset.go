...
// hubctl branch reset sg://my-user/my-repo/main --commit commitId --prefix path --object path
var branchResetCmd = &cobra.Command{
  ...
  1. reset all uncommitted changes - reset sg://my-user/my-repo/main
  2. reset uncommitted changes under specific path - reset sg://my-user/my-repo/main --prefix path
  3. reset uncommitted changes for specific object - reset sg://my-user/my-repo/main --object path`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		resp, err := clt.ResetBranchWithResponse(cmd.Context(), apigen.RepositoryOwner(u.Repository), apigen.RepositoryName(u.Repository), u.Ref, apigen.ResetBranchJSONRequestBody(reset))
