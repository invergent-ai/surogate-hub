...
// setupCmd initial Surogate Hub system setup - build the database, load initial data and create first superuser
var setupCmd = &cobra.Command{
	Use:     "setup",
	Aliases: []string{"init"},
	Short:   "Setup a new Surogate Hub instance with initial credentials",
