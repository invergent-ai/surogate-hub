...
title: lakectl (Surogate Hub command-line tool)
...
# lakectl (Surogate Hub command-line tool)
{:.no_toc}
...
[Download lakectl](https://github.com/invergent-ai/surogate-hub/releases){: .btn .btn-green target="_blank"}
