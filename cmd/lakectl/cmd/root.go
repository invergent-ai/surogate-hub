...
var rootCmd = &cobra.Command{
	...
	Long:  `lakectl is a CLI tool allowing exploration and manipulation of a Surogate Hub environment`,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&baseURI, "base-uri", "", os.Getenv("LAKECTL_BASE_URI"), "base URI used for Surogate Hub address parse")
