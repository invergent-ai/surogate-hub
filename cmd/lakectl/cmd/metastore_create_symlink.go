...
func init() {
	_ = metastoreCreateSymlinkCmd.Flags().String("repo", "", "Surogate Hub repository name")
	_ = metastoreCreateSymlinkCmd.MarkFlagRequired("repo")
	_ = metastoreCreateSymlinkCmd.Flags().String("branch", "", "Surogate Hub branch name")
	_ = metastoreCreateSymlinkCmd.MarkFlagRequired("branch")
	_ = metastoreCreateSymlinkCmd.Flags().String("path", "", "path to table on Surogate Hub")
