    ...
    return (
        <NavDropdown title={<NavBarTitle />} className="navbar-username" align="end">
            ...
            <NavDropdown.Item href={versionResponse.upgrade_url}>
                    ...
                    New Surogate Hub version is available!
                    </>
            ...
            <NavDropdown.Item disabled={true}>
                <small>Surogate Hub {versionResponse.version}</small>
            </NavDropdown.Item></>}
        </NavDropdown>
    );
};
        ...
        return (
            ...
            <Container fluid={true}>
                <Link component={Navbar.Brand} href="/">
                    <span className="logo">DenseMAX</span><span className="logo-smaller">FS</span>
                </Link>
            </Container>
            </Navbar>
        );
