...
const GroupsContainer = () => {
    ...
    const headers = ['', 'Group Name', 'Permission', 'Created At'];
        ...
        <>
            ...
            <DataTable
                ...
                rowFn={group => {
                    ...
                    const acl = group.acl || {permission: '', repositories: [], all_repositories: true};
                    elements.push(<ACLPermission initialValue={acl.permission} onSelect={
                            ((permission) => auth.putACL(group.id, {...acl, permission})
