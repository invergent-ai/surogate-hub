...
public class PathList {
  ...
  **/
   ...
   * @return the PathList instance itself
   */
  public PathList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paths, pathList.paths)&&
        Objects.equals(this.additionalProperties, pathList.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PathList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PathList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PathList>() {
           ...
           public PathList read(JsonReader in) throws IOException {
             ...
             PathList instance = thisAdapter.fromJsonTree(jsonObj);
