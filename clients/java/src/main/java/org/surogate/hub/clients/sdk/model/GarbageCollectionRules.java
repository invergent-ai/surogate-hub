...
import org.surogate.hub.clients.sdk.model.GarbageCollectionRule;
...
public class GarbageCollectionRules {
  ...
  **/
   ...
   * @return the GarbageCollectionRules instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultRetentionDays, garbageCollectionRules.defaultRetentionDays) &&
        ...
        Objects.equals(this.additionalProperties, garbageCollectionRules.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultRetentionDays, branches, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to GarbageCollectionRules
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GarbageCollectionRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (int i = 0; i < jsonArraybranches.size(); i++) {
        GarbageCollectionRule.validateJsonElement(jsonArraybranches.get(i));
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GarbageCollectionRules>() {
           ...
           public GarbageCollectionRules read(JsonReader in) throws IOException {
             ...
             GarbageCollectionRules instance = thisAdapter.fromJsonTree(jsonObj);
