...
public class Repository {
  ...
  **/
  ...
  public Repository storageId(String storageId) {
  ...
  **/
   ...
   * @return the Repository instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, repository.id) &&
        ...
        Objects.equals(this.storageId, repository.storageId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, creationDate, defaultBranch, storageId, storageNamespace, readOnly, metadata, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Repository>() {
           ...
           public Repository read(JsonReader in) throws IOException {
             ...
             Repository instance = thisAdapter.fromJsonTree(jsonObj);
