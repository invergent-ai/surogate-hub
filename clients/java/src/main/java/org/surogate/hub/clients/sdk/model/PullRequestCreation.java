...
public class PullRequestCreation {
  ...
  **/
   ...
   * @return the PullRequestCreation instance itself
   */
  public PullRequestCreation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, pullRequestCreation.title) &&
        ...
        Objects.equals(this.additionalProperties, pullRequestCreation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, sourceBranch, destinationBranch, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestCreation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestCreation is not found in the empty JSON string", PullRequestCreation.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PullRequestCreation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestCreation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestCreation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestCreation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestCreation.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestCreation>() {
           @Override
           public void write(JsonWriter out, PullRequestCreation value) throws IOException {
           ...
           @Override
           public PullRequestCreation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PullRequestCreation instance = thisAdapter.fromJsonTree(jsonObj);
