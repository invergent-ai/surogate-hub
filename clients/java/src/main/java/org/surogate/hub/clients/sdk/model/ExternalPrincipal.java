...
public class ExternalPrincipal {
  ...
  **/
  ...
  public ExternalPrincipal userId(String userId) {
   ...
   /**
   * Surogate Hub user ID to associate with an external principal. 
   * @return userId
  **/
  @javax.annotation.Nonnull
  ...
  **/
   ...
   * @return the ExternalPrincipal instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, externalPrincipal.id) &&
        ...
        Objects.equals(this.additionalProperties, externalPrincipal.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, userId, settings, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExternalPrincipal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExternalPrincipal is not found in the empty JSON string", ExternalPrincipal.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExternalPrincipal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExternalPrincipal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExternalPrincipal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExternalPrincipal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExternalPrincipal.class));

       return (TypeAdapter<T>) new TypeAdapter<ExternalPrincipal>() {
           @Override
           public void write(JsonWriter out, ExternalPrincipal value) throws IOException {
           ...
           @Override
           public ExternalPrincipal read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ExternalPrincipal instance = thisAdapter.fromJsonTree(jsonObj);
