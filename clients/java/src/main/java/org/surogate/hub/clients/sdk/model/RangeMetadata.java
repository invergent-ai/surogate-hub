...
public class RangeMetadata {
  ...
  **/
   ...
   * @return the RangeMetadata instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, rangeMetadata.id) &&
        ...
        Objects.equals(this.additionalProperties, rangeMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, minKey, maxKey, count, estimatedSize, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RangeMetadata>() {
           ...
           public RangeMetadata read(JsonReader in) throws IOException {
             ...
             RangeMetadata instance = thisAdapter.fromJsonTree(jsonObj);
