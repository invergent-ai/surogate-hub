...
import org.surogate.hub.clients.sdk.model.AccessKeyCredentials;
...
public class Setup {
  ...
  **/
   ...
   * @return the Setup instance itself
   */
  public Setup putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Setup>() {
           ...
           public Setup read(JsonReader in) throws IOException {
             ...
             Setup instance = thisAdapter.fromJsonTree(jsonObj);
