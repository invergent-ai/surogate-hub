...
public class BranchProtectionRule {
  ...
  **/
   ...
   * @return the BranchProtectionRule instance itself
   */
  public BranchProtectionRule putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BranchProtectionRule>() {
           ...
           public BranchProtectionRule read(JsonReader in) throws IOException {
             ...
             BranchProtectionRule instance = thisAdapter.fromJsonTree(jsonObj);
