...
public class RepositoryRestoreStatus {
  ...
  public RepositoryRestoreStatus() {
  }
  ...
  **/
   ...
   * @return the RepositoryRestoreStatus instance itself
   */
  public RepositoryRestoreStatus putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RepositoryRestoreStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryRestoreStatus is not found in the empty JSON string", RepositoryRestoreStatus.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RepositoryRestoreStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryRestoreStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryRestoreStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryRestoreStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryRestoreStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryRestoreStatus>() {
           @Override
           public void write(JsonWriter out, RepositoryRestoreStatus value) throws IOException {
           ...
           @Override
           public RepositoryRestoreStatus read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             RepositoryRestoreStatus instance = thisAdapter.fromJsonTree(jsonObj);
