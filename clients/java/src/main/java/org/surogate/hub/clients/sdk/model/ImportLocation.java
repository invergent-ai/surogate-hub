...
public class ImportLocation {
  ...
  **/
  ...
  public ImportLocation path(String path) {
   ...
   /**
   * A source location to a &#39;common_prefix&#39; or to a single object. Must match the Hub installation blockstore type.
   * @return path
  **/
  @javax.annotation.Nonnull
  ...
  **/
   ...
   * @return the ImportLocation instance itself
   */
  public ImportLocation putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportLocation is not found in the empty JSON string", ImportLocation.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportLocation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportLocation>() {
           @Override
           public void write(JsonWriter out, ImportLocation value) throws IOException {
           ...
           @Override
           public ImportLocation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ImportLocation instance = thisAdapter.fromJsonTree(jsonObj);
