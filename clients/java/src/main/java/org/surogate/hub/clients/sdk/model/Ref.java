...
public class Ref {
  ...
  **/
   ...
   * @return the Ref instance itself
   */
  public Ref putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, ref.id) &&
        ...
        Objects.equals(this.additionalProperties, ref.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, commitId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Ref>() {
           ...
           public Ref read(JsonReader in) throws IOException {
             ...
             Ref instance = thisAdapter.fromJsonTree(jsonObj);
