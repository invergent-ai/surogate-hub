...
public class RepositoryList {
  ...
  **/
   ...
   * @return the RepositoryList instance itself
   */
  public RepositoryList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pagination, repositoryList.pagination) &&
        ...
        Objects.equals(this.additionalProperties, repositoryList.additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArrayresults.size(); i++) {
        Repository.validateJsonElement(jsonArrayresults.get(i));
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RepositoryList>() {
           ...
           public RepositoryList read(JsonReader in) throws IOException {
             ...
             RepositoryList instance = thisAdapter.fromJsonTree(jsonObj);
