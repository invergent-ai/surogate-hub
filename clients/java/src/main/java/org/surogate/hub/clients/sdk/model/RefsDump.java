...
public class RefsDump {
  ...
  **/
   ...
   * @return the RefsDump instance itself
   */
  public RefsDump putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commitsMetaRangeId, refsDump.commitsMetaRangeId) &&
        ...
        Objects.equals(this.additionalProperties, refsDump.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitsMetaRangeId, tagsMetaRangeId, branchesMetaRangeId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to RefsDump
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefsDump.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RefsDump>() {
           ...
           public RefsDump read(JsonReader in) throws IOException {
             ...
             RefsDump instance = thisAdapter.fromJsonTree(jsonObj);
