...
public class MergeResult {
  ...
  **/
   ...
   * @return the MergeResult instance itself
   */
  public MergeResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reference, mergeResult.reference)&&
        Objects.equals(this.additionalProperties, mergeResult.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reference, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MergeResult>() {
           ...
           public MergeResult read(JsonReader in) throws IOException {
             ...
             MergeResult instance = thisAdapter.fromJsonTree(jsonObj);
