...
public class AuthenticationToken {
  ...
  **/
   ...
   * @return the AuthenticationToken instance itself
   */
  public AuthenticationToken putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, authenticationToken.token) &&
        ...
        Objects.equals(this.additionalProperties, authenticationToken.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, tokenExpiration, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AuthenticationToken>() {
           ...
           public AuthenticationToken read(JsonReader in) throws IOException {
             ...
             AuthenticationToken instance = thisAdapter.fromJsonTree(jsonObj);
