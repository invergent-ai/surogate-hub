...
public class AccessKeyCredentials {
  ...
  **/
   ...
   * @return the AccessKeyCredentials instance itself
   */
  public AccessKeyCredentials putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKeyId, accessKeyCredentials.accessKeyId) &&
        ...
        Objects.equals(this.additionalProperties, accessKeyCredentials.additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessKeyCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessKeyCredentials is not found in the empty JSON string", AccessKeyCredentials.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessKeyCredentials.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessKeyCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessKeyCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessKeyCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessKeyCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessKeyCredentials>() {
           @Override
           public void write(JsonWriter out, AccessKeyCredentials value) throws IOException {
           ...
           @Override
           public AccessKeyCredentials read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AccessKeyCredentials instance = thisAdapter.fromJsonTree(jsonObj);
