...
public class CurrentUser {
  ...
  **/
   ...
   * @return the CurrentUser instance itself
   */
  public CurrentUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.user, currentUser.user)&&
        Objects.equals(this.additionalProperties, currentUser.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CurrentUser>() {
           ...
           public CurrentUser read(JsonReader in) throws IOException {
             ...
             CurrentUser instance = thisAdapter.fromJsonTree(jsonObj);
