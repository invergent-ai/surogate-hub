...
public class TagCreation {
  ...
  **/
   ...
   * @return the TagCreation instance itself
   */
  public TagCreation putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagCreation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagCreation is not found in the empty JSON string", TagCreation.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TagCreation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagCreation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagCreation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagCreation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagCreation.class));

       return (TypeAdapter<T>) new TypeAdapter<TagCreation>() {
           @Override
           public void write(JsonWriter out, TagCreation value) throws IOException {
           ...
           @Override
           public TagCreation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TagCreation instance = thisAdapter.fromJsonTree(jsonObj);
