...
public class TaskInfo {
  ...
  **/
   ...
   * @return the TaskInfo instance itself
   */
  public TaskInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, taskInfo.id)&&
        Objects.equals(this.additionalProperties, taskInfo.additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : TaskInfo.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TaskInfo>() {
           ...
           public TaskInfo read(JsonReader in) throws IOException {
             ...
             TaskInfo instance = thisAdapter.fromJsonTree(jsonObj);
