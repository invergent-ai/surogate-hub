...
public class ACL {
  ...
  **/
   ...
   * @return the ACL instance itself
   */
  public ACL putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.permission, ACL.permission)&&
        Objects.equals(this.additionalProperties, ACL.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(permission, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ACL>() {
           ...
           public ACL read(JsonReader in) throws IOException {
             ...
             ACL instance = thisAdapter.fromJsonTree(jsonObj);
