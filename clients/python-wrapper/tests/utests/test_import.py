...
from surogate_hub.exceptions import ImportManagerException
from surogate_hub.import_manager import ImportManager
    ...
    def test_import_start_wait(self, monkeypatch):
        ...
        with monkeypatch.context():
            def monkey_import_start(*_, **__):
                return surogate_hub_sdk.ImportCreationResponse(id="import_id")

            monkeypatch.setattr(surogate_hub_sdk.ImportApi, "import_start", monkey_import_start)
            res = mgr.start()
            ...
            requests = 5
            status = surogate_hub_sdk.ImportStatus(completed=False,
            ...
            monkeypatch.setattr(surogate_hub_sdk.ImportApi, "import_status", monkey_import_status)
