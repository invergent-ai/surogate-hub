...
class TestConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Config:
        ...
        if include_optional:
            return Config(
                version_config = surogate_hub_sdk.models.version_config.VersionConfig(
                    version = '', 
                    latest_version = '', 
                    upgrade_recommended = True, 
                    upgrade_url = '', ),
                storage_config = surogate_hub_sdk.models.storage_config.StorageConfig(
                    blockstore_type = '', 
                ...
                storage_config_list = [
                    surogate_hub_sdk.models.storage_config.StorageConfig(
                        blockstore_type = '', 
                        blockstore_namespace_example = '', 
                        blockstore_namespace_validity_regex = '', 
                        default_namespace_prefix = '', 
