# surogate_hub_sdk.ExperimentalApi
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    ...
    abort_presign_multipart_upload = surogate_hub_sdk.AbortPresignMultipartUpload() # AbortPresignMultipartUpload |  (optional)
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    ...
    upload_id = 'upload_id_example' # str | 
    path = 'path_example' # str | relative to the branch
    complete_presign_multipart_upload = surogate_hub_sdk.CompletePresignMultipartUpload() # CompletePresignMultipartUpload |  (optional)
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    ...
    external_principal_creation = surogate_hub_sdk.ExternalPrincipalCreation() # ExternalPrincipalCreation |  (optional)
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.ExperimentalApi(api_client)
    external_login_information = surogate_hub_sdk.ExternalLoginInformation() # ExternalLoginInformation |  (optional)
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.ExperimentalApi(api_client)
    sts_auth_request = surogate_hub_sdk.StsAuthRequest() # StsAuthRequest | 
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    ...
    update_object_user_metadata = surogate_hub_sdk.UpdateObjectUserMetadata() # UpdateObjectUserMetadata | 
