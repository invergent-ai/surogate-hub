...
**checksum** | **str** |  | 
**size_bytes** | **int** | The number of bytes in the object.  Surogate Hub always populates this field when returning ObjectStats.  This field is optional _for the client_ to supply, for instance on upload.  | [optional] 
