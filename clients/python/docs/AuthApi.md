...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.AuthApi(api_client)
    group_creation = surogate_hub_sdk.GroupCreation() # GroupCreation |  (optional)
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.AuthApi(api_client)
    policy = surogate_hub_sdk.Policy() # Policy | 
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.AuthApi(api_client)
    user_creation = surogate_hub_sdk.UserCreation() # UserCreation |  (optional)
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.AuthApi(api_client)
    login_information = surogate_hub_sdk.LoginInformation() # LoginInformation |  (optional)
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = surogate_hub_sdk.AuthApi(api_client)
    group_id = 'group_id_example' # str | 
    acl = surogate_hub_sdk.ACL() # ACL | 

    try:
        # set ACL of group
        api_instance.set_group_acl(group_id, acl)
    except Exception as e:
