...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Surogate Hub storage configuration |  -  |
**401** | Unauthorized |  -  |
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.InternalApi(api_client)
    stats_events_list = surogate_hub_sdk.StatsEventsList() # StatsEventsList | 
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.InternalApi(api_client)
    setup = surogate_hub_sdk.Setup() # Setup | 
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = surogate_hub_sdk.InternalApi(api_client)
    comm_prefs_input = surogate_hub_sdk.CommPrefsInput() # CommPrefsInput | 
...
with surogate_hub_sdk.ApiClient(configuration) as api_client:
    ...
    object_stage_creation = surogate_hub_sdk.ObjectStageCreation() # ObjectStageCreation | 
