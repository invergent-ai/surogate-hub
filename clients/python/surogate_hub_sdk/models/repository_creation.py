...
class RepositoryCreation(BaseModel):
    ...
    storage_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the underlying data store")
    ...
    __properties: ClassVar[List[str]] = ["name", "storage_id", "storage_namespace", "default_branch", "sample_data", "read_only", "metadata"]
