...
class ImportCreation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["paths", "commit", "force"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paths": [ImportLocation.from_dict(_item) for _item in obj["paths"]] if obj.get("paths") is not None else None,
            "commit": CommitCreation.from_dict(obj["commit"]) if obj.get("commit") is not None else None,
