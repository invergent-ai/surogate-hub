...
class MetaRangeCreation(BaseModel):
    ...
    MetaRangeCreation
    """ # noqa: E501
    ranges: Annotated[List[RangeMetadata], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ranges": [RangeMetadata.from_dict(_item) for _item in obj["ranges"]] if obj.get("ranges") is not None else None
        })
        return _obj
