...
class BranchCreation(BaseModel):
    ...
    hidden: Optional[StrictBool] = Field(default=False, description="When set, branch will not show up when listing branches by default. *EXPERIMENTAL*")
    __properties: ClassVar[List[str]] = ["name", "source", "force", "hidden"]
