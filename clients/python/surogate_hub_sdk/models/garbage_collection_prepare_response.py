...
class GarbageCollectionPrepareResponse(BaseModel):
    ...
    gc_commits_presigned_url: Optional[StrictStr] = Field(default=None, description="a presigned url to download the commits csv")
    __properties: ClassVar[List[str]] = ["run_id", "gc_commits_location", "gc_addresses_location", "gc_commits_presigned_url"]
