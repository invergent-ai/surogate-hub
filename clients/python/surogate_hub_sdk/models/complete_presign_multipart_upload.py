...
class CompletePresignMultipartUpload(BaseModel):
    ...
    parts: List[UploadPart] = Field(description="List of uploaded parts, should be ordered by ascending part number")
    ...
    __properties: ClassVar[List[str]] = ["physical_address", "parts", "user_metadata", "content_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parts": [UploadPart.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
