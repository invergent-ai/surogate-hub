...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "basic_auth": BasicAuthSetting,
        "jwt_token": BearerFormatAuthSetting,
        "cookie_auth": APIKeyAuthSetting,
        "oidc_auth": APIKeyAuthSetting,
        "saml_auth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = surogate_hub_sdk.Configuration(
...
conf = surogate_hub_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("surogate_hub_sdk")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "/api/v1",
                'description': "Surogate Hub server endpoint",
            }
        ]
