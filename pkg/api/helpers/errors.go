...
var (
	// ErrUnsupportedProtocol is the error returned when Surogate Hub server requests the client
	// use a protocol it does not know about.  Until recompiled to use a newer client,
	// upload the object using through the Surogate Hub server.
	ErrUnsupportedProtocol = errors.New("unsupported protocol")

	// ErrRequestFailed is an error returned for failing Surogate Hub server replies.
