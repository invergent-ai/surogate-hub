...
func setBaseDefaults(cfgType string) {
	...
	viper.SetDefault("actions.env.prefix", "SGHUBACTION_")
	...
	viper.SetDefault("committed.local_cache.dir", "~/sghub/data/cache")
	...
	viper.SetDefault("committed.block_storage_prefix", "_hub")
	...
	viper.SetDefault("gateways.s3.domain_name", "s3.local.sghub.io")
	...
	viper.SetDefault("blockstore.local.path", "~/sghub/data/block")
	...
	viper.SetDefault("stats.address", "https://stats.sghub.io")
	...
	viper.SetDefault("security.audit_check_url", "https://audit.sghub.io/audit")
	viper.SetDefault("security.check_latest_version", true)
	viper.SetDefault("security.check_latest_version_cache", time.Hour)

	viper.SetDefault("database.local.path", "~/sghub/metadata")
