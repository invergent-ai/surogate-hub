...
local sym_exporter = require("sghub/catalogexport/symlink_exporter")

--[[
    Generate glue table name
    @descriptor(Table): object from (i.e _hub_tables/my_table.yaml)
...
--[[
    ...
    @table_src_path(string): path to table spec (i.e _hub_tables/my_table.yaml)
...
local function export_glue(glue, db, table_src_path, create_table_input, action_info, options)
    ...
    -- get table desctiptor from _hub_tables/
