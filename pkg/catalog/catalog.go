...
import (
	...
	"github.com/invergent-ai/surogate-hub/pkg/graveler/staging"
	"github.com/invergent-ai/surogate-hub/pkg/ident"
	"github.com/invergent-ai/surogate-hub/pkg/kv"
	"github.com/invergent-ai/surogate-hub/pkg/logging"
	"github.com/invergent-ai/surogate-hub/pkg/pyramid"
	pyramidparams "github.com/invergent-ai/surogate-hub/pkg/pyramid/params"
...
func (c *Catalog) ListRepositories(ctx context.Context, limit int, prefix, searchString, after string) ([]*Repository, bool, error) {
	...
	for it.Next() {
		...
		metadata, _ := c.Store.GetRepositoryMetadata(ctx, record.RepositoryID)
...
func (c *Catalog) CopyEntry(ctx context.Context, srcRepository, srcRef, srcPath, destRepository, destBranch, destPath string, replaceSrcMetadata bool, metadata Metadata, opts ...graveler.SetOptionsFunc) (*DBEntry, error) {
	...
	// The mtime (creationDate) in Surogate Hub to be as close as possible to the mtime in the underlying storage
