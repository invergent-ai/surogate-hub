...
func TestBranchSimpleIterator(t *testing.T) {
	...
	t.Run("listing all branches", func(t *testing.T) {
		iter, err := ref.NewBranchSimpleIterator(ctx, kvStore, repo, graveler.ListOptions{ShowHidden: true})
...
func TestBranchByCommitIterator(t *testing.T) {
	...
	t.Run("listing all branches", func(t *testing.T) {
		iter, err := ref.NewBranchByCommitIterator(ctx, kvStore, repo, graveler.ListOptions{ShowHidden: true})
		require.NoError(t, err)
