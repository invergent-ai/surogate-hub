...
| `extraVolumes`                        | Additional volumes attached to the Surogate Hub and init-job pods (in yaml syntax)                                                                                                                                                                                                         | `[]` See [values.yaml](values.yaml) |
| `extraVolumeMounts`                   | Additional volume mounts for the Surogate Hub container and init-job (in yaml syntax)                                                                                                                                                                                                      | `[]` See [values.yaml](values.yaml) |
